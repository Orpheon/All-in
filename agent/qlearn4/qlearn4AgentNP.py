...
from agent.qlearn4 import models
from agent.qlearn4 import replaybuffer
...
class Qlearn4AgentNP(BaseAgentNP):
  MODEL_FILES = ['q.modelb']
  logger = EpochLogger(output_dir='qlearn4/logs', output_fname='progress.csv')

  def __str__(self):
    return 'Qln4 {} {}'.format('T' if self.trainable else 'N', super().__str__())
