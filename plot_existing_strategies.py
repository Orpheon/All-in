...
def draw_traditional_metrics(agent_manager, hue='type', filename='traditional_scatterplot.png'):
...
# draw_traditional_metrics(agent_manager, hue='type', filename="traditional_scatterplot_type.png")
